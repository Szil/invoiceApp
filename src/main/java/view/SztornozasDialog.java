...
public class SztornozasDialog extends javax.swing.JDialog implements ActionListener, InvoiceInterface {
    ...
    private void initComponents() {
        ...
        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel(new String[]{"Pénznem", "HUF", "EUR", "USD"}));
        ...
        jComboBox6.setModel(new javax.swing.DefaultComboBoxModel(new String[]{"Pénznem", "HUF", "EUR", "USD"}));
        ...
        jComboBox7.setModel(new javax.swing.DefaultComboBoxModel(new String[]{"Pénznem", "HUF", "EUR", "USD"}));
